...
function BookingHistory() {
  ...
  // 
    ...
    const CompletedHisroty = () => {
      axios.post('/api/user/completedtrips',{"userId":USERID}).then((res)=>{
          // console.log(res);
...
<Typography variant='h4' component='h6' textAlign='center' >BOOKING HISTORY</Typography>
      <TabContext value={value}>
...

        {
          history != 0? 
          <Box>
              <Typography variant='h4' component='h6' >Pending Trips</Typography>
      <br/>
      <br/>
       ...
       
  {
      history.map((obj , index)=>{
        ...
        <Button size="small"  variant='outlined' color='error'  onClick={()=>cancelhandler(`${obj._id}`)}  >Cancel Booking <CancelIcon/> </Button>
          ...
          :
          <Typography variant='h4' component='h6' >No Pending Trips</Typography>
        }
        ...
        <TabPanel value="2">
          {
            completedTrips != 0 ?
            <Box>
               <Typography variant='h4' component='h6' >Completed Trips</Typography>
      <br/>
      <br/>
      <Grid container spacing={2} >
        {
      completedTrips.map((obj , index)=>{
        ...
        <CardActions>
        <Typography variant='subtitle2' color='#8bc34a' component='div' >Completed</Typography> 
        </CardActions>
      </Card>
      </Grid>
            ...
            :
            <Typography variant='h4' component='h6' >No Completed Trips</Typography>
          }
       ...
       <TabPanel value="3">
{
  cancelledTrip != 0 ?
  <Box>
    <Typography variant='h4' component='h6' >Cancelled Trips</Typography>
<br/>
<br/>
<Grid container spacing={2} >
  {
cancelledTrip.map((obj , index)=>{
  ...
  <CardActions>
  <Typography variant='subtitle2' color='error' component='div' >Cancelled</Typography>
  </CardActions>
</Card>
</Grid>
  ...
  :
  <Typography variant='h4' component='h6' >No cancelled Trips</Typography>
}
