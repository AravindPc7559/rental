                    ...
                    <Grid container >
                       ...
                       <div class="thumbsup-icon">
                            ...
                            <svg class="thumbsup" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 187 109">
                                <path d="M55 66H33c-4.3 0-8.7-1-12.5-2.9l-7.1-3.5c-.5-.3-.9-.8-.9-1.4v-22c0-.4.1-.7.4-1l15.3-18.4v-12A4.7 4.7 0 0 1 35.3.7c5.4 3.1 5.6 11.1 5.6 16.6v7.9h17.3c4.3 0 7.9 3.5 7.9 7.8v.2L63 58.3a8.1 8.1 0 0 1-8 7.7z" fill="#0095ff" transform="translate(58 19)"/>
                                <path d="M14.1 66H1.6C.7 66 0 65.3 0 64.4V29.9c0-.9.7-1.6 1.6-1.6h12.6c.9 0 1.6.7 1.6 1.6v34.6c-.1.8-.8 1.5-1.7 1.5z" fill="#17c" transform="translate(58 19)"/>
                            </svg>
                        </div>
                       </Grid>
                       <br/>
                       <Grid item xs={12} sm={12} md={12} lg={12} xl={12} >
                            ...
                            <Typography variant='h3' component='h4'  >
                                Thank You For Using Roadster Your Rental Car Booked Successfully!
                            </Typography>
                            </div>
