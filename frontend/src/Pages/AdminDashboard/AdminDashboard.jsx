...
console.log(maxUsedCar);
  ...
  return (
    <div>
      ...
      <Grid container spacing={4} >  
          ...
          <Typography variant='h4' component='h6' textAlign='center' paddingTop={7} fontFamily='monospace' >Revenu: <NumberEasing
  value={revenuTotal}
  speed={3000}
  decimals={0}
  ease='quintInOut' />/-</Typography>
          </Paper>
          ...
          <Grid  sm={12} xs={12} md={6} lg={4} xl={4}>
          <Paper elevation={12}  style={{width:400,height:150}} >
            <Typography variant='h4' component='h6' textAlign='center' paddingTop={7} fontFamily='monospace' >Total <NumberEasing
  value={UserLenght}
  speed={3000}
  decimals={0}
  ease='quintInOut' /> Users</Typography>
          </Paper>
  ...
  speed={3000}
  decimals={0}
  ease='quintInOut' /> Cars</Typography>
            </Paper>
